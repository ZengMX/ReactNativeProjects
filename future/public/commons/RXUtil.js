exports.get = function(medicinalTypeCode, prescriptionTypeCode){
	...
	if(medicinalTypeCode == "0"){
		if(prescriptionTypeCode =="0") return require("./res/000chufangyao_d.png");
		if(prescriptionTypeCode =="1") return require("./res/000yaojia_d.png");
		if(prescriptionTypeCode =="2") return require("./res/000yaoyi_d.png");
	}else{
		return null;
	}
};
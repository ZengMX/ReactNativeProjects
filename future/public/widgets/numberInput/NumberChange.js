	...
	render() {
		...
		return (
			<View style={[{ flexDirection: 'row', justifyContent: 'flex-start', width: 90 }, this.props.style]}>
				...
				<View style={{flex:1,height:29, borderColor: "#e5e5e5", borderTopWidth: 1/PixelRatio.get(), borderBottomWidth: 1/PixelRatio.get()}}>
					<TextInput ref='input'
					...
					<TouchableOpacity style={{position: "absolute", width: 32, height: 29, top: 0}} 
					onPress={()=>{
						this.props.onTextClick && this.props.onTextClick();
					} }>
					</TouchableOpacity>
				</View>
